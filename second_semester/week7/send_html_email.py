...
class HtmlEmailSender:
    ...
    def __init__(self, sender_email, sender_password, smtp_server='smtp.gmail.com', smtp_port=587):
        ...
        Args:
            ...
            smtp_port (int): SMTP 서버 포트 (기본값: 587)
        """
        ...
        <head>
            ...
            <style>
                ...
                .header h1 {{
                    margin: 0;
                    font-size: 28px;
                    background: linear-gradient(45deg, #4a9eff, #ff6b6b, #4ecdc4);
        ...
        <body>
            <div class="container">
                ...
                <div class="footer">
                    ...
                    <p>이 메일은 Python을 통해 자동으로 전송되었습니다.</p>
                </div>
            </div>
        </body>
        </html>
...
class NaverEmailSender(HtmlEmailSender):
    """네이버 메일 전송을 위한 클래스 (보너스 과제)"""
...
def main():
    """메인 함수 - CSV 파일에서 수신자 목록을 읽어서 HTML 메일 전송"""
    ...
    # Gmail EmailSender 객체 생성
    email_sender = HtmlEmailSender(sender_email, sender_password)
